...
Here is a link to the article - {LINK}',
	...
	'KB_HEADER_DESC_EXPLAIN'			=> 'The description on each category page that describes the content of the knowledgebase, <br /><b>Note:</b> Length is 255 characters after the html characters are replaced using <a href="http://php.net/manual/en/function.htmlspecialchars.php" target="_blank">htmlspecialchars</a>',
